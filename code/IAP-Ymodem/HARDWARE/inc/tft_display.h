...
#define LCD_RS         	GPIO_Pin_3	//TFT --RS/DC
#define LCD_CS        	GPIO_Pin_7  //TFT --CS/CE
#define LCD_RST     	GPIO_Pin_4	//TFT --RST



//液晶控制口置1操作语句宏定义
#define	LCD_CS_SET  	GPIOD->BSRRL=LCD_CS    
#define	LCD_RS_SET  	GPIOD->BSRRL=LCD_RS       
#define	LCD_RST_SET  	GPIOD->BSRRL=LCD_RST    

//液晶控制口置0操作语句宏定义
#define	LCD_CS_CLR  	GPIOD->BSRRH=LCD_CS    
#define	LCD_RS_CLR  	GPIOD->BSRRH=LCD_RS      
#define	LCD_RST_CLR  	GPIOD->BSRRH=LCD_RST    
